...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Fetch records from Airtable using the "[⚙️ Ops] AI AGENT PROFILER" view
    const airtableUrl = `https://api.airtable.com/v0/${AIRTABLE_BASE_ID}/lavoratori_selezionati?view=${encodeURIComponent('[⚙️ Ops] AI AGENT PROFILER')}`
